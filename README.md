...
* **현재 상태**: 현재는 **일반/공중/롱노트/샌드백 등의 노트 채보(Chart Notes)**의 커스텀 로드 및 보스 액션 트리거 실험만을 주로 지원합니다.
* **향후 계획**: 향후 곡 선택 및 분류를 원활하게 돕기 위한 **커스텀 태그(Custom Tag)** 기능에 대한 지원 및 실험을 추가할 예정입니다.
