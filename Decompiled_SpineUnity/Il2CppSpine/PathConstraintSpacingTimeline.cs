...
public class PathConstraintSpacingTimeline : PathConstraintPositionTimeline
{
	...
	static PathConstraintSpacingTimeline()
	{
		Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-unity.dll", "Spine", "PathConstraintSpacingTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, 100663394);
		NativeMethodInfoPtr_get_PropertyId_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, 100663395);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, 100663396);
	}

	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 782265, RefRangeEnd = 782269, XrefRangeStart = 782265, XrefRangeEnd = 782269, MetadataInitTokenRva = 47162144L, MetadataInitFlagRva = 59849704L)]
	public unsafe PathConstraintSpacingTimeline(int frameCount)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 782272, XrefRangeEnd = 782275, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void Apply(Skeleton skeleton, float lastTime, float time, ExposedList<Event> events, float alpha, MixBlend blend, MixDirection direction)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
	...
	public PathConstraintSpacingTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
