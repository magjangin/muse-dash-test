...
public class RotateTimeline : CurveTimeline
{
	...
	{
		Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-unity.dll", "Spine", "RotateTimeline");
		...
		NativeFieldInfoPtr_frames = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr, "frames");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr, 100663340);
		NativeMethodInfoPtr_get_PropertyId_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr, 100663341);
		NativeMethodInfoPtr_SetFrame_Public_Void_Int32_Single_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr, 100663342);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RotateTimeline>.NativeClassPtr, 100663343);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 782063, RefRangeEnd = 782065, XrefRangeStart = 782058, XrefRangeEnd = 782063, MetadataInitTokenRva = 47158324L, MetadataInitFlagRva = 59849710L)]
	public unsafe RotateTimeline(int frameCount)
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 782065, RefRangeEnd = 782069, XrefRangeStart = 782065, XrefRangeEnd = 782065, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetFrame(int frameIndex, float time, float degrees)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[3];
		*ptr = (nint)(&frameIndex);
		*(float**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &time;
		*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &degrees;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 782069, XrefRangeEnd = 782075, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
