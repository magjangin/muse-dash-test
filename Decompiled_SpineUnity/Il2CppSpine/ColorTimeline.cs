...
public class ColorTimeline : CurveTimeline
{
	...
	static ColorTimeline()
	{
		Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-unity.dll", "Spine", "ColorTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_slotIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, "slotIndex");
		NativeFieldInfoPtr_frames = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, "frames");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, 100663354);
		NativeMethodInfoPtr_get_PropertyId_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, 100663355);
		NativeMethodInfoPtr_SetFrame_Public_Void_Int32_Single_Single_Single_Single_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, 100663356);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr, 100663357);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 782108, RefRangeEnd = 782110, XrefRangeStart = 782103, XrefRangeEnd = 782108, MetadataInitTokenRva = 46431060L, MetadataInitFlagRva = 59849657L)]
	public unsafe ColorTimeline(int frameCount)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ColorTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 782110, RefRangeEnd = 782114, XrefRangeStart = 782110, XrefRangeEnd = 782110, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetFrame(int frameIndex, float time, float r, float g, float b, float a)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 782114, XrefRangeEnd = 782118, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ColorTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
