...
public class ScaleTimeline : TranslateTimeline
{
	...
	static ScaleTimeline()
	{
		Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-unity.dll", "Spine", "ScaleTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663348);
		NativeMethodInfoPtr_get_PropertyId_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663349);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663350);
	}

	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 782092, RefRangeEnd = 782096, XrefRangeStart = 782091, XrefRangeEnd = 782092, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ScaleTimeline(int frameCount)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 782096, XrefRangeEnd = 782100, MetadataInitTokenRva = 47184904L, MetadataInitFlagRva = 59849711L)]
	...
	public ScaleTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
