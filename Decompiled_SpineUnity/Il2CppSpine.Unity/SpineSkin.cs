...
public class SpineSkin : SpineAttributeBase
{
	...
	public unsafe bool defaultAsEmptyString
	{
		...
		set
		{
			*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_defaultAsEmptyString)) = flag;
		}
	}
	...
	static SpineSkin()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_String_String_Boolean_Boolean_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpineSkin>.NativeClassPtr, 100664394);
	}
	...
	public unsafe SpineSkin(string startsWith = "", string dataField = "", bool includeNone = true, bool fallbackToTextField = false, bool defaultAsEmptyString = false)
