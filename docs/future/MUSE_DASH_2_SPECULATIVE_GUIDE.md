...
- 이때, 2편에 새롭게 추가된 기믹 노트(예: 3선 노트, 특수 연출 노트 등)가 있다면 6자리 UID 파싱 규칙([BMS_PARSING.md](file:///h:/source/repos/muse%20dash%20test/docs/custom_charts/BMS_PARSING.md))에 해당 노트 유형 코드를 분기 처리해 얹어주면 끝납니다.
