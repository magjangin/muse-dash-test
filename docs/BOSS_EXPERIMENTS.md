...
실제 로그에서 같이 보면 좋은 프리팹/지상공중 정보는 아래처럼 정리할 수 있습니다.

| xxyy | pathway | 의미 | 프리팹 예 |
| --- | --- | --- | --- |
| `0902` | `0` | 지상 | `090902_road_1_nor_2` |
| `0903` | `0` | 지상 | `010903_road_1_nor_3` |
| `0906` | `1` | 공중 | `010906_air_1_nor_3` |
| `0908` | `0` | 지상 | `090908_road_2_nor_2` |
| `0909` | `0` | 지상 | `010909_road_2_nor_3` |
| `0911` | `1` | 공중 | `090911_air_2_nor_2` |
| `0912` | `1` | 공중 | `010912_air_2_nor_3` |

여기서 `pathway=0`은 지상(`road`), `pathway=1`은 공중(`air`)입니다. 프리팹은 보통 `{uid}_{road/air}_{nor/up/down}_{variant}` 형태로 보이고, 마지막 숫자(`2`, `3` 등)는 변형 번호처럼 관찰됩니다.
