...
자세한 파일별 설명은 [`CODE_REFERENCE.md`](CODE_REFERENCE.md), 사용법은 [`CUSTOM_CHART_GUIDE.md`](../guides/CUSTOM_CHART_GUIDE.md), 로그 해석은 [`LOGGING_AND_TROUBLESHOOTING.md`](../guides/LOGGING_AND_TROUBLESHOOTING.md)를 봅니다.
...
| 필요 | 문서 |
| --- | --- |
| 전체 지도 | [`ARCHITECTURE.md`](ARCHITECTURE.md) |
| 파일별 상세 설명 | [`CODE_REFERENCE.md`](CODE_REFERENCE.md) |
| 커스텀 곡 제작법 | [`CUSTOM_CHART_GUIDE.md`](../guides/CUSTOM_CHART_GUIDE.md) |
| BMS 규칙 | [`BMS_PARSING.md`](../guides/BMS_PARSING.md) |
| 로그/문제 해결 | [`LOGGING_AND_TROUBLESHOOTING.md`](../guides/LOGGING_AND_TROUBLESHOOTING.md) |
| UID/태그 주입 | [`UID_INJECTION.md`](../experiments/UID_INJECTION.md), [`CAST_AND_CUSTOM_TAG_GUIDE.md`](CAST_AND_CUSTOM_TAG_GUIDE.md) |
| 보스/씬 연출 | [`BOSS_EXPERIMENTS.md`](../experiments/BOSS_EXPERIMENTS.md), [`SCENE_BACKGROUND_SWAP.md`](../experiments/SCENE_BACKGROUND_SWAP.md) |
